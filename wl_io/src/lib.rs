...
/// AsyncBufWriteWithFd directly, because we expect to only serialize to binary,
/// but this might change in the future.
pub trait Serialize {
    /// Serialize into the buffered writer. This function returns no errors, failures in seializing
    /// are generally program errors, and triggers panicking.
    ///
    /// # Panic
    ///
