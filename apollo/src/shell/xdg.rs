use std::{
    num::{NonZeroU32, Wrapping}, marker::PhantomData,
};

use derivative::Derivative;
use wl_common::utils::geometry::{Logical, Rectangle, Extent};
use wl_protocol::stable::xdg_shell::{xdg_surface::v5 as xdg_surface, xdg_toplevel::v5 as xdg_toplevel};
